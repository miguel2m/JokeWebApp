...
namespace JokeWebApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        {
            return View(await _context.Joke.Include(rt => rt.User).ToListAsync());
        ...
        {
            return View("Index",await _context.Joke.Include(rt => rt.User).Where(j => j.JokeQuestion.Contains(SearchPhrase)).ToListAsync());
